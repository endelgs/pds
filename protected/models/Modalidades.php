...
class Modalidades extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('id_modalidade, nome', 'required'),
			array('id_modalidade, nome', 'length', 'max'=>255),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id_modalidade, nome', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('id_modalidade',$this->id_modalidade,true);
